...
```{r eval=TRUE, echo=TRUE}
historic_state_data_url <- "https://api.covidactnow.org/v2/states.timeseries.json?apiKey=d7373b25e54f4af1ae3b4adf4ad9b72b"
raw_data <- httr::GET(historic_state_data_url)
