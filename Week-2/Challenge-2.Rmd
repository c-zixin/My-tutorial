...
**Solution:** CSV is highly compaitible with various data analysis tools and languages.
<br>
<br>
...
```
<br>
```{$r, out.height= "400px",out.width= "800px",echo=TRUE,eval=TRUE,fig.cap="What Read_CSV means"}
...
**Solution:** It tells R to skip specified number of rows of data. 
<br>
<br>
...
```{r,echo=TRUE,eval=TRUE}
ggplot(playlist_data) + aes(x=Age,y=Rating) + geom_point(shape="x")
...
```{r,echo=TRUE,eval=TRUE}
ggplot(playlist_data) + aes(x=Age,y=Rating) + geom_point(shape="x") + labs(x="Age", Y="Rating" , title= "Age Vs Ratings", caption = "The data does not prove that age affects rating.")
